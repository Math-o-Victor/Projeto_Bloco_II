...
-- -----------------------------------------------------
-- Table `db_projetoIntegrador`.`tb_vendedora`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_projetoIntegrador`.`tb_vendedora` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `db_projetoIntegrador`.`tb_produtos` (
  ...
  CONSTRAINT `fk_tb_produtos_tb_categoria`
    ...
    REFERENCES `db_projetoIntegrador`.`tb_categoria` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_produtos_tb_vendedora1`
    FOREIGN KEY (`vendedora_id`)
    REFERENCES `db_projetoIntegrador`.`tb_vendedora` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
